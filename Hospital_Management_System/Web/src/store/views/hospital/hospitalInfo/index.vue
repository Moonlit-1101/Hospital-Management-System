<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="病人联系电话" prop="contactNumber">
        <el-input
      ...
      <el-form-item label="病人入院日期" prop="admissionDate">
      ...
      <el-form-item label="病人出院日期" prop="dischargeDate">
        <el-date-picker clearable
      ...
      <el-form-item label="是否住院治疗" prop="isAdmission">
        <el-input
          v-model="queryParams.isAdmission"
          placeholder="请输入是否住院治疗"
          clearable
          @keyup.enter="handleQuery"
        />
      </el-form-item>
      ...
      <el-form-item label="治疗方案" prop="treatmentPlan">
        <el-input
          v-model="queryParams.treatmentPlan"
          placeholder="请输入治疗方案"
          clearable
          @keyup.enter="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="hospitalInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="是否住院治疗" align="center" prop="isAdmission">
        <template #default="scope">
          <dict-tag :options="sys_yes_no" :value="scope.row.isAdmission"/>
        </template>
      </el-table-column>
      ...
      <el-table-column label="病人状态" align="center" prop="patientState" />
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="hospitalInfoRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="是否住院治疗" prop="isAdmission">
          <el-input v-model="form.isAdmission" placeholder="请输入是否住院治疗" />
        </el-form-item>
...
const data = reactive({
  ...
  rules: {
    ...
    admissionDate: [
      { required: true, message: "病人入院日期不能为空", trigger: "blur" }
    ],
  }
});
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('是否确认删除就诊人员编号为"' + _patientIds + '"的数据项？').then(function() {
