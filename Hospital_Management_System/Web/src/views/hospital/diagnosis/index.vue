...
<!--      <el-table-column label="病人入院日期" align="center" prop="admissionDate" width="180">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['hospital:hospitalInfo:edit']">医生诊断</el-button>
...
import {diagnosisListHospitalInfo} from "../../../api/hospital/hospitalInfo";
...
function getList() {
  loading.value = true;
    diagnosisListHospitalInfo(queryParams.value).then(response => {
