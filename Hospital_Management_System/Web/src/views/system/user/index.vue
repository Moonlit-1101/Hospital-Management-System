      ...
      <el-row :gutter="20">
         ...
         <el-col :span="20" :xs="24">
            ...
            <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
               ...
               <el-table-column label="分类" align="center" key="deptName" prop="dept.deptName" v-if="columns[3].visible" :show-overflow-tooltip="true" />
      ...
      <el-dialog :title="title" v-model="open" width="600px" append-to-body>
         <el-form :model="form" :rules="rules" ref="userRef" label-width="80px">
            ...
            <el-row>
               ...
               <el-col :span="12">
                  <el-form-item v-if="form.userId == undefined" label="人员密码" prop="password">
                     <el-input v-model="form.password" placeholder="请输入人员密码" type="password" maxlength="20" show-password />
                  </el-form-item>
               </el-col>
            </el-row>
            <el-row>
...
const data = reactive({
  ...
  rules: {
    ...
    nickName: [{ required: true, message: "姓名不能为空", trigger: "blur" }],
     deptId: [{ required: true, message: "分类不能为空", trigger: "blur" }],
    password: [{ required: true, message: "人员密码不能为空", trigger: "blur" }, { min: 5, max: 20, message: "人员密码长度必须介于 5 和 20 之间", trigger: "blur" }, { pattern: /^[^<>"'|\\]+$/, message: "不能包含非法字符：< > \" ' \\\ |", trigger: "blur" }],
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('是否确认删除人员编号为"' + userIds + '"的数据项？').then(function () {
...
function handleStatusChange(row) {
  ...
  proxy.$modal.confirm('确认要"' + text + '""' + row.userName + '"人员吗?').then(function () {
